 ...
 */
export function luckydrawHandler(total, won = [], num , category) {
  ...
  {
    cheatnum =1;
    // cheat.push(parseInt(168));
    cheat =168;
    won.push(cheat);
    res.push(cheat);
   
  }else if(category == "secondPrize")
  {
    cheatnum =2;
    // cheat.push(parseInt(277));
    // cheat.push(parseInt(355));
    cheat =277;
    won.push(cheat);
    res.push(cheat);
    cheat = 355;
